...
namespace Acquia\GovCore\Composer;
...
final class AssetPackagist {
   ...
   * that contains a dependency on acquia/govcore.
   *
  ...
  protected static function getRootPackage() {
    ...
    do {
      if ($file->exists()) {
        ...
        if (isset($info['require']['acquia/govcore'])) {
          return $file;
        }
      }
      chdir('..');
  ...
  public static function execute(Event $event) {
    ...
    // Search upwards for a composer.json which depends on acquia/govcore.
    ...
    // oomphinc/composer-installers-extender is required by GovCore and
