/**
 * @file
 * Cook County Admin's enhancement for autocomplete form element.
 */

(($, Drupal, once) => {
  Drupal.behaviors.cook_county_adminAutoCompete = {
    attach(context) {
      once('cook_county_adminAutoComplete', 'input.form-autocomplete', context).forEach(
        (value) => {
          const $input = $(value);
          const timeout = 400;
