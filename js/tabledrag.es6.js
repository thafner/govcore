...
(($, Drupal) => {
   ...
   */
  Drupal.behaviors.cook_county_adminTableDrag = {
    attach(context, settings) {
       ...
       *   </tr>
       * @example
       * <!-- Cook County Admin tabledrag structure, this fixes the wrapping problem. -->
       *   <tr class="draggable">
      ...
      Object.keys(settings.tableDrag || {}).forEach((base) => {
        $(context)
          ...
          .once('cook_county_adminTabledrag')
  ...
  $.extend(Drupal.tableDrag.prototype.row.prototype, {
    ...
    /**
     * Moves added indents into Cook County Admin's wrapper element.
     *
