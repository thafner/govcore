...
# Install Drupal.
drush site:install govcore --yes --config ./drush.yml --account-pass admin --db-url $DB_URL
...
echo "  require '/var/www/site-php/govcorenightly/govcorenightly-settings.inc';" >> $SETTINGS
