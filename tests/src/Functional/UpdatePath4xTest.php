...
/**
 * Tests the update path from GovCore 4.x.
 *
 * @group govcore
 */
class UpdatePath4xTest extends UpdatePathTestBase {
  ...
  protected function replaceUser1() {
    ...
    // through Layout Builder and GovCore Media is triggered, resulting in
    // the use of an old media source plugin ID that will not exist after the
    // updates are run. Normally, GovCore Media accounts for this by aliasing
    ...
    // @see govcore_media_instagram_media_source_info_alter()
  ...
  /**
   * Tests updating from GovCore 4.1.0-beta1 via the UI.
   */
