...
/**
 * Tests integrated functionality of the GovCore profile.
 *
 * @group govcore
 * @group orca_public
 */
class GovCoreTest extends BrowserTestBase {
  ...
  protected static $configSchemaCheckerExclusions = [
    ...
    // @todo Remove when requiring GovCore Layout 2.2 or later.
   ...
   * {@inheritdoc}
   */
  protected $profile = 'govcore_extender';
   ...
   * Tests integrated functionality of the GovCore profile.
   *
   * Because it takes aeons to install the GovCore profile, or any of its
   ...
   * performance reasons.
   */
  public function testGovCore() {
    // Test that the sub-profile was installed...
    $this->assertSame('govcore_extender', $this->container->getParameter('install_profile'));
    ...
    $this->assertArrayNotHasKey('govcore_search', $module_list);

    // GovCore's configuration overrides should have taken effect.
  ...
  /**
   * Tests the 'text' custom block type that ships with GovCore.
   */
